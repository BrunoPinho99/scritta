...
const NotificationsView: React.FC<NotificationsViewProps> = ({ notifications, onMarkAsRead, onMarkAllAsRead, onClearAll, onAction, onClose }) => {
        ...
        <div className="flex items-center gap-3 w-full md:w-auto justify-between md:justify-end">
          <div className="flex flex-wrap gap-2">
            ...
            {onClearAll && (
              <button
                onClick={onClearAll}
                className="ml-2 text-rose-500 text-sm font-bold hover:underline"
